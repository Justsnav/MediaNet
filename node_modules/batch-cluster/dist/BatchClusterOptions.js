...
exports.BatchClusterOptions = exports.minuteMs = exports.secondMs = void 0;
...
class BatchClusterOptions {
     ...
     */
    maxProcAgeMillis = 5 * exports.minuteMs;
    /**
     ...
     */
    onIdleIntervalMillis = 10 * exports.secondMs;
    /**
     ...
     */
    spawnTimeoutMillis = 15 * exports.secondMs;
    /**
     ...
     */
    minDelayBetweenSpawnMillis = 1.5 * exports.secondMs;
    /**
    ...
    /**
     * When a task's pass/fail token is detected on one stream (stdout or
     * stderr), this is how long to wait for the *other* stream to flush before
     * running the parser.
     *
    ...
    streamFlushMillis = Platform_1.isMac ? 100 : Platform_1.isWin ? 200 : 30;
    /**
     ...
     * Set this to 0 to disable this feature.
     */
    pidCheckIntervalMillis = 2 * exports.minuteMs;
    /**
