...
class ProcessTerminator {
     ...
     */
    constructor(opts, killFn, killGroupOnlyFn) {
        this.opts = opts;
        this.#logger = opts.logger;
        this.#kill = killFn ?? (0, Pids_1.killerFor)(opts);
        this.#killGroupOnly = killGroupOnlyFn ?? Pids_1.killGroupOnly;
    }
    /**
    ...
    #forceKillIfRunning(proc, processName, isRunning) {
        if (!this.opts.cleanupChildProcs || proc.pid == null)
            return;
        ...
        const groupKilled = this.opts.killProcessGroup && this.#killGroupOnly(proc.pid, true);
        ...
        if (directChildRunning && killed) {
            ...
            this.#logger().warn(`${processName}.terminate(): force-killed still-running child.`);
        }
    }
