...
const InvalidUtf8Bytes_1 = require("./InvalidUtf8Bytes");
...
const Utf8JsonFilter_1 = require("./Utf8JsonFilter");
/**
...
class ReadTask extends ExifToolTask_1.ExifToolTask {
    ...
    constructor(sourceFile, args, options) {
        ...
        this.#unwrapInvalidUtf8 = (0, Utf8JsonFilter_1.hasBuiltInUtf8Filter)(args);
    ...
    static for(filename, options) {
        ...
        const readArgs = (0, Array_1.toArray)(opts.readArgs);
        const args = [
            ...FilenameCharsetArgs_1.Utf8FilenameCharsetArgs,
            "-json",
            ...readArgs,
            ...(0, Utf8JsonFilter_1.utf8JsonFilterArgs)(readArgs),
        ];
        ...
        if (opts.imageHashType != null && opts.imageHashType !== false) {
            if (!ExifToolOptions_1.ImageHashTypes.includes(opts.imageHashType)) {
                throw new Error(`Invalid imageHashType: ${JSON.stringify(opts.imageHashType)}. ` +
                    `Expected false or one of ${ExifToolOptions_1.ImageHashTypes.values.join(", ")}.`);
            }
        ...
        for (const ea of opts.numericTags) {
            (0, TagNameValidation_1.validateTagName)(ea, "numericTags entry");
            args.push("-" + ea + "#");
        }
    ...
    parse(data, err) {
        try {
            ...
            const parsed = JSON.parse(versionFixedData)[0];
            const decoded = this.#unwrapInvalidUtf8
                ? (0, InvalidUtf8Bytes_1.unwrapInvalidUtf8Tags)(parsed)
                : { tags: parsed };
