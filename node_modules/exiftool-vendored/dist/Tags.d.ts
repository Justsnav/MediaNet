...
export interface CompositeTags {
     ...
     * @frequency 🔥 ★★★☆ (20%)
     * @groups Composite, XMP
     * @example "Ð¤Ð¸Ð»Ð¾ÑÐ¾Ñ„ÑÐºÐ¸Ð¸Ì† Ð´Ð²Ð¾Ñ€Ð¸Ðº, Ñ€ÐµÐ»ÑŒÐµÑ„Ñ‹ Ð¢Ð…v, 1970"
     ...
     * @frequency 🔥 ☆☆☆☆ (2%)
     * @groups Composite, MakerNotes, XMP
     * @example "Taumatawhakatangihangakōauauotamateapōkaiwhenuakitānatahu"
     */
    Location?: string;
    /**
     * @frequency 🔥 ★★★★ (100%)
...
export interface EXIFTags {
     ...
     * @remarks UTC time of GPS fix. When writing, date is stripped off if present, and time is adjusted to UTC if it includes a timezone
     * @see https://exiftool.org/TagNames/GPS.html
     */
     ...
     * @groups EXIF, MakerNotes, XMP
     * @example 9956
     * @remarks Image number/identifier. XMP-aux namespace.
     ...
     * @frequency 🧊 ☆☆☆☆ (0%)
     * @groups EXIF
     * @example "d4368ca3c83a7c5545d9c8384dad0c9c"
     */
     ...
     * @frequency 🧊 ☆☆☆☆ (0%)
     * @groups EXIF
     * @example "(Binary data 3158080 bytes, use -b option to extract)"
     */
     ...
     * @frequency 🧊 ☆☆☆☆ (0%)
     * @groups EXIF
     * @example "(Binary data 7155 bytes, use -b option to extract)"
     */
     ...
     * @groups EXIF, XMP
     * @example 99
     * @remarks Microsoft-specific percentage rating (1-99).
...
export declare const JUMBFTagsNames: StrEnum<"Actions" | "Alg" | "Exclusions" | "Hash" | "InstanceID" | "Item0" | "Item1" | "Item3" | "JUMDLabel" | "JUMDType" | "Pad" | "Pad2" | "Parts" | "Signature">;
...
export declare const MPFTagsNames: StrEnum<"PreviewImage" | "DependentImage1EntryNumber" | "DependentImage2EntryNumber" | "ImageUIDList" | "MPFVersion" | "MPImageFlags" | "MPImageFormat" | "MPImageLength" | "MPImageStart" | "MPImageType" | "NumberOfImages" | "TotalFrames">;
...
export declare const PanasonicRawTagsNames: StrEnum<"FocusStepCount" | "Orientation" | "ApertureValue" | "DistortionCorrection" | "FocalLengthIn35mmFormat" | "ShutterSpeedValue" | "FlashFired" | "FocusStepNear" | "LensTypeMake" | "LensTypeModel" | "WhiteBalanceSet" | "DistortionScale" | "NumWBEntries">;
...
export declare const IPTCTagsNames: StrEnum<"DateCreated" | "Keywords" | "CodedCharacterSet" | "DigitalCreationDate" | "DigitalCreationTime" | "EnvelopeRecordVersion" | "TimeCreated">;
...
export declare const RAFTagsNames: StrEnum<"BitsPerSample" | "FirmwareVersion" | "BlackLevel" | "StripByteCounts" | "StripOffsets" | "ChromaticAberrationParams" | "FujiLayout" | "GeometricDistortionParams" | "RAFCompression" | "RawExposureBias" | "RawImageAspectRatio" | "RawImageCroppedSize" | "RawImageCropTopLeft" | "RawImageFullHeight" | "RawImageFullSize" | "RawImageFullWidth" | "RawZoomActive" | "RawZoomSize" | "RawZoomTopLeft" | "VignettingParams" | "XTransLayout">;
...
export declare const RIFFTagsNames: StrEnum<"BitsPerSample" | "DateTimeOriginal" | "FrameRate" | "ImageHeight" | "ImageWidth" | "Quality" | "Software" | "FrameCount" | "VideoFrameRate" | "AudioSampleRate" | "AudioCodec" | "AudioSampleCount" | "AvgBytesPerSec" | "Encoding" | "MaxDataRate" | "NumChannels" | "SampleRate" | "SampleSize" | "StreamCount" | "StreamType" | "VideoCodec" | "VideoFrameCount">;
...
export interface MakerNotesTags {
     ...
     * @frequency 🔥 ☆☆☆☆ (1%)
     * @groups MakerNotes
     * @example "1.006910168 -0.02202510258 -0.04414990859"
     */
     ...
     * @example "Off"
     */
    HighFrequencyFlickerReduction?: string;
    /**
     * @frequency 🔥 ★☆☆☆ (8%)
     * @groups MakerNotes
     * @example "n/a"
     ...
     * @groups MakerNotes, XMP
     * @example "Very Blank"
     * @remarks Image title. XMP-dc (Dublin Core) namespace - use this standard schema instead of non-standard XMP-xmp:Title.
...
export interface XMPTags {
     ...
     * @remarks Tracks editing history of the document. XMP-xmpMM (Media Management) struct type.
     ...
     * @frequency 🔥 ☆☆☆☆ (2%)
     * @groups XMP
     * @example "2026:03:13 18:38:39.859"
     ...
     * @groups XMP
     * @example
     * @remarks Version history of the document. XMP-xmpMM (Media Management) struct type.
 ...
 *
 * Autogenerated by "npm run mktags" by ExifTool 13.59 on Wed Jul 15 2026.
 * 3001 unique tags were found in 10526 photo and video files.
 *
