...
exports.hasBuiltInUtf8Filter = hasBuiltInUtf8Filter;
exports.utf8JsonFilterArgs = utf8JsonFilterArgs;
...
const Utf8ReplacementFilter = String.raw `
  Filter=if (Image::ExifTool::IsUTF8(\$_) < 0) {
    ...
    unless ($binary) {
      ...
      $_ = {
        "${InvalidUtf8Bytes_1.InvalidUtf8Marker}" => {
          replacement => "s:" . $_,
...
`
    ...
    .join(" ");
const BuiltInUtf8FilterArgs = ["-api", Utf8ReplacementFilter];
const ApiArg = /^-api$/i;
...
function hasBuiltInUtf8Filter(args) {
...
//# sourceMappingURL=Utf8JsonFilter.js.map